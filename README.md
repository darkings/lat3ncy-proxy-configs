...
两端都启用 IPv6 和系统 DNS，并让 Tailscale 的 100.64.0.0/10、fd7a:115c:a1e0::/48、*.ts.net、*.tailscale.com 绕过代理和 TUN、优先直连。香港、台湾、日本、新加坡、美国是五个固定地区自动测速组；只有订阅节点名称匹配对应地区正则时，组内才会出现节点。
